...
void EvcsnmApplication::indicate(const DataIndication& indication, UpPacketPtr packet)
{
    ...
    pubsub->publish(config_s.evcsnm, evcsnm_json, &evcsnm_udp_socket, &evcsnm_remote_endpoint, &evcsnm_err, evcsnm_rx_counter, evcsnm_rx_latency, cp.time_received, time_encoded, "EVCSNM");
...
void EvcsnmApplication::on_message(string topic, string mqtt_message, const std::vector<uint8_t>& bytes, bool is_encoded, double time_reception, vanetza::geonet::Router* router) {
