...
private:
    ...
    Document buildJSON(DENM_PDU_Description_DENM_t denm, double time_reception, int rssi, int packet_size, double time_queue, channel channel_info, string source);
};
