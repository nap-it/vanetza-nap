...
private:
    ...
    Document buildJSON(CAM_t cam, Document& cam_json_full, double time_reception, double time_queue, int rssi, int packet_size, bool include_fields, bool rx, bool full);
