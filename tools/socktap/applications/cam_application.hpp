...
private:
    ...
    Document buildJSON(CAM_PDU_Description_CAM_t cam, Document& cam_json_full, double time_reception, double time_queue, int rssi, int packet_size, channel channel_info, bool include_fields, bool rx, bool full, string source);
