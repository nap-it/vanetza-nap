...
std::unique_ptr<LinkLayer> create_link_layer(boost::asio::io_context& io_context, const EthernetDevice& device, const std::string& name, const std::string& device_name, const bool rssi_enabled, std::string ipv4_address, int ipv4_port, std::string ipv4_interface)
{
