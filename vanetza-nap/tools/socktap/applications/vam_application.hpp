...
private:
    ...
    Document buildJSON(VAM_t vam, Document& vam_json_full, double time_reception, int rssi, int packet_size, double time_queue, channel channel_info, string source);
