...
public:
    ...
    */
    ...
    GenericValue& operator[](const GenericValue<Encoding, SourceAllocator>& name) {
        ...
        if (member != MemberEnd())
            ...
            std::string errorMessage = "Element " + std::string(name.GetString()) + " is missing or does not have the correct name!";
            RAPIDJSON_EXCEPTION(false, errorMessage.c_str());
    ...
    /*! \pre IsObject() == true */
    ConstMemberIterator MemberBegin() const { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return ConstMemberIterator(GetMembersPointer()); }
    //! Const \em past-the-end member iterator
    /*! \pre IsObject() == true */
    ConstMemberIterator MemberEnd() const   { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return ConstMemberIterator(GetMembersPointer() + data_.o.size); }
    //! Member iterator
    /*! \pre IsObject() == true */
    MemberIterator MemberBegin()            { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return MemberIterator(GetMembersPointer()); }
    //! \em Past-the-end member iterator
    /*! \pre IsObject() == true */
    MemberIterator MemberEnd()              { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return MemberIterator(GetMembersPointer() + data_.o.size); }
    ...
    */
    GenericValue& MemberReserve(SizeType newCapacity, Allocator &allocator) {
        RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object");
    ...
    */
    ...
    Object GetObject() { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return Object(*this); }
    Object GetObj() { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return Object(*this); }
    ConstObject GetObject() const { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return ConstObject(*this); }
    ConstObject GetObj() const { RAPIDJSON_EXCEPTION(IsObject(), "Invalid value type! Expected: Object"); return ConstObject(*this); }
    ...
    SizeType Size() const { RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List"); return data_.a.size; }

    //! Get the capacity of array.
    SizeType Capacity() const { RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List"); return data_.a.capacity; }

    //! Check whether the array is empty.
    bool Empty() const { RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List"); return data_.a.size == 0; }
    ...
    */
    GenericValue& operator[](SizeType index) {
        RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List");
    ...
    //! Element iterator
    /*! \pre IsArray() == true */
    ValueIterator Begin() { RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List"); return GetElementsPointer(); }
    //! \em Past-the-end element iterator
    /*! \pre IsArray() == true */
    ValueIterator End() { RAPIDJSON_EXCEPTION(IsArray(), "Invalid value type! Expected: List"); return GetElementsPointer() + data_.a.size; }
    ...
    */
    ...
    int GetInt() const          { RAPIDJSON_EXCEPTION(data_.f.flags & kIntFlag, "Invalid value type! Expected: Integer");   return data_.n.i.i;   }
    unsigned GetUint() const    { RAPIDJSON_EXCEPTION(data_.f.flags & kUintFlag, "Invalid value type! Expected: Integer");  return data_.n.u.u;   }
    int64_t GetInt64() const    { RAPIDJSON_EXCEPTION(data_.f.flags & kInt64Flag, "Invalid value type! Expected: Integer"); return data_.n.i64; }
    uint64_t GetUint64() const  { RAPIDJSON_EXCEPTION(data_.f.flags & kUint64Flag, "Invalid value type! Expected: Integer"); return data_.n.u64; }

    //! Get the value as double type.
    /*! \note If the value is 64-bit integer type, it may lose precision. Use \c IsLosslessDouble() to check whether the converison is lossless.
    */
    double GetDouble() const {
        RAPIDJSON_EXCEPTION(IsNumber(), "Invalid value type! Expected: Float");
        if ((data_.f.flags & kDoubleFlag) != 0)                return data_.n.d;   // exact type, no conversion.
        if ((data_.f.flags & kIntFlag) != 0)                   return data_.n.i.i; // int -> double
        if ((data_.f.flags & kUintFlag) != 0)                  return data_.n.u.u; // unsigned -> double
        if ((data_.f.flags & kInt64Flag) != 0)                 return static_cast<double>(data_.n.i64); // int64_t -> double (may lose precision)
        RAPIDJSON_EXCEPTION((data_.f.flags & kUint64Flag) != 0, "Invalid value type! Expected: Float");  return static_cast<double>(data_.n.u64); // uint64_t -> double (may lose precision)
    }
    ...
    */
    ...
    const Ch* GetString() const { RAPIDJSON_EXCEPTION(IsString(), "Invalid value type! Expected: String"); return DataString(data_); }
