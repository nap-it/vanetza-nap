...
static int asn_validate_EuroValue(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EuroValue value = *(e_EuroValue*)sptr;
    switch(value) {
    case EuroValue_noEntry:
    case EuroValue_euro_1:
    case EuroValue_euro_2:
    case EuroValue_euro_3:
    case EuroValue_euro_4:
    case EuroValue_euro_5:
    case EuroValue_euro_6:
    case EuroValue_reservedForUse1:
    case EuroValue_reservedForUse2:
    case EuroValue_reservedForUse3:
    case EuroValue_reservedForUse4:
    case EuroValue_reservedForUse5:
    case EuroValue_reservedForUse6:
    case EuroValue_reservedForUse7:
    case EuroValue_reservedForUse8:
    case EuroValue_eev:
        return 0;
    }
    return -1;
