...
static int asn_validate_PositioningSolutionType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PositioningSolutionType value = *(e_PositioningSolutionType*)sptr;
    switch(value) {
    case PositioningSolutionType_noPositioningSolution:
    case PositioningSolutionType_sGNSS:
    case PositioningSolutionType_dGNSS:
    case PositioningSolutionType_sGNSSplusDR:
    case PositioningSolutionType_dGNSSplusDR:
    case PositioningSolutionType_dR:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PositioningSolutionType = {
		...
		/sizeof(asn_DEF_PositioningSolutionType_tags_1[0]), /* 1 */
	{
		...
		asn_validate_PositioningSolutionType
	},
