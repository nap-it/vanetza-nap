...
typedef enum ETSI_ITS_CDD_CollisionRiskSubCauseCode {
	...
	ETSI_ITS_CDD_CollisionRiskSubCauseCode_collisionRiskWithPedestrian	= 5,
	ETSI_ITS_CDD_CollisionRiskSubCauseCode_collisionRiskWithCyclist	= 6,
	ETSI_ITS_CDD_CollisionRiskSubCauseCode_collisionRiskWithMotorVehicle	= 7
