...
extern asn_TYPE_descriptor_t asn_DEF_ext1 __attribute__((weak, alias("asn_DEF_ext1_10")));
#else
static asn_TYPE_descriptor_t asn_DEF_ext1_10;
asn_TYPE_descriptor_t asn_DEF_ext1;
__attribute__((constructor)) static void asn_DEF_ext1_10_alias_init(void) {
	asn_DEF_ext1 = asn_DEF_ext1_10;
}
#endif
