...
static int asn_validate_LayerType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_LayerType value = *(e_LayerType*)sptr;
    switch(value) {
    case LayerType_none:
    case LayerType_mixedContent:
    case LayerType_generalMapData:
    case LayerType_intersectionData:
    case LayerType_curveData:
    case LayerType_roadwaySectionData:
    case LayerType_parkingAreaData:
    case LayerType_sharedLaneData:
        return 0;
    }
    return -1;
}
