...
static int asn_validate_SegmentAttributeXY(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SegmentAttributeXY value = *(e_SegmentAttributeXY*)sptr;
    switch(value) {
    case SegmentAttributeXY_reserved:
    case SegmentAttributeXY_doNotBlock:
    case SegmentAttributeXY_whiteLine:
    case SegmentAttributeXY_mergingLaneLeft:
    case SegmentAttributeXY_mergingLaneRight:
    case SegmentAttributeXY_curbOnLeft:
    case SegmentAttributeXY_curbOnRight:
    case SegmentAttributeXY_loadingzoneOnLeft:
    case SegmentAttributeXY_loadingzoneOnRight:
    case SegmentAttributeXY_turnOutPointOnLeft:
    case SegmentAttributeXY_turnOutPointOnRight:
    case SegmentAttributeXY_adjacentParkingOnLeft:
    case SegmentAttributeXY_adjacentParkingOnRight:
    case SegmentAttributeXY_adjacentBikeLaneOnLeft:
    case SegmentAttributeXY_adjacentBikeLaneOnRight:
    case SegmentAttributeXY_sharedBikeLane:
    case SegmentAttributeXY_bikeBoxInFront:
    case SegmentAttributeXY_transitStopOnLeft:
    case SegmentAttributeXY_transitStopOnRight:
    case SegmentAttributeXY_transitStopInLane:
    case SegmentAttributeXY_sharedWithTrackedVehicle:
    case SegmentAttributeXY_safeIsland:
    case SegmentAttributeXY_lowCurbsPresent:
    case SegmentAttributeXY_rumbleStripPresent:
    case SegmentAttributeXY_audibleSignalingPresent:
    case SegmentAttributeXY_adaptiveTimingPresent:
    case SegmentAttributeXY_rfSignalRequestPresent:
    case SegmentAttributeXY_partialCurbIntrusion:
    case SegmentAttributeXY_taperToLeft:
    case SegmentAttributeXY_taperToRight:
    case SegmentAttributeXY_taperToCenterLine:
    case SegmentAttributeXY_parallelParking:
    case SegmentAttributeXY_headInParking:
    case SegmentAttributeXY_freeParking:
    case SegmentAttributeXY_timeRestrictionsOnParking:
    case SegmentAttributeXY_costToPark:
    case SegmentAttributeXY_midBlockCurbPresent:
    case SegmentAttributeXY_unEvenPavementPresent:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SegmentAttributeXY = {
		...
		/sizeof(asn_DEF_SegmentAttributeXY_tags_1[0]), /* 1 */
	{
		...
		asn_validate_SegmentAttributeXY
	},
