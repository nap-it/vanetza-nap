...
static int asn_validate_RestrictionAppliesTo(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RestrictionAppliesTo value = *(e_RestrictionAppliesTo*)sptr;
    switch(value) {
    case RestrictionAppliesTo_none:
    case RestrictionAppliesTo_equippedTransit:
    case RestrictionAppliesTo_equippedTaxis:
    case RestrictionAppliesTo_equippedOther:
    case RestrictionAppliesTo_emissionCompliant:
    case RestrictionAppliesTo_equippedBicycle:
    case RestrictionAppliesTo_weightCompliant:
    case RestrictionAppliesTo_heightCompliant:
    case RestrictionAppliesTo_pedestrians:
    case RestrictionAppliesTo_slowMovingPersons:
    case RestrictionAppliesTo_wheelchairUsers:
    case RestrictionAppliesTo_visualDisabilities:
    case RestrictionAppliesTo_audioDisabilities:
    case RestrictionAppliesTo_otherUnknownDisabilities:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RestrictionAppliesTo = {
		...
		/sizeof(asn_DEF_RestrictionAppliesTo_tags_1[0]), /* 1 */
	{
		...
		asn_validate_RestrictionAppliesTo
	},
