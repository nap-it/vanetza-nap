...
extern asn_TYPE_descriptor_t asn_DEF_tyreType __attribute__((weak, alias("asn_DEF_tyreType_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_tyreType_4;
asn_TYPE_descriptor_t asn_DEF_tyreType;
__attribute__((constructor)) static void asn_DEF_tyreType_4_alias_init(void) {
	asn_DEF_tyreType = asn_DEF_tyreType_4;
}
#endif
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_numberOfAxles __attribute__((weak, alias("asn_DEF_numberOfAxles_9")));
#else
static asn_TYPE_descriptor_t asn_DEF_numberOfAxles_9;
asn_TYPE_descriptor_t asn_DEF_numberOfAxles;
__attribute__((constructor)) static void asn_DEF_numberOfAxles_9_alias_init(void) {
	asn_DEF_numberOfAxles = asn_DEF_numberOfAxles_9;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_vehicleAxlesNumber __attribute__((weak, alias("asn_DEF_vehicleAxlesNumber_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_vehicleAxlesNumber_3;
asn_TYPE_descriptor_t asn_DEF_vehicleAxlesNumber;
__attribute__((constructor)) static void asn_DEF_vehicleAxlesNumber_3_alias_init(void) {
	asn_DEF_vehicleAxlesNumber = asn_DEF_vehicleAxlesNumber_3;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
...
static int asn_validate_tyreType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_VehicleAxles__vehicleAxlesNumber__tyreType value = *(e_VehicleAxles__vehicleAxlesNumber__tyreType*)sptr;
    switch(value) {
    case VehicleAxles__vehicleAxlesNumber__tyreType_notSpecified:
    case VehicleAxles__vehicleAxlesNumber__tyreType_singleTyre:
    case VehicleAxles__vehicleAxlesNumber__tyreType_dualTyres:
    case VehicleAxles__vehicleAxlesNumber__tyreType_reservedForUse:
        return 0;
    }
    return -1;
}
