...
static int asn_validate_DriveDirection(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_DriveDirection value = *(e_DriveDirection*)sptr;
    switch(value) {
    case DriveDirection_forward:
    case DriveDirection_backward:
    case DriveDirection_unavailable:
        return 0;
    }
    return -1;
}
