...
extern asn_TYPE_descriptor_t asn_DEF_regional __attribute__((weak, alias("asn_DEF_regional_8")));
#else
static asn_TYPE_descriptor_t asn_DEF_regional_8;
asn_TYPE_descriptor_t asn_DEF_regional;
__attribute__((constructor)) static void asn_DEF_regional_8_alias_init(void) {
	asn_DEF_regional = asn_DEF_regional_8;
}
#endif
