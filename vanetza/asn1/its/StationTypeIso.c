...
static int asn_validate_StationTypeIso(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_StationTypeIso value = *(e_StationTypeIso*)sptr;
    switch(value) {
    case StationTypeIso_unspecified:
    case StationTypeIso_closedEntryWithPayment:
    case StationTypeIso_closedEntryWithoutPayment:
    case StationTypeIso_closedTransit:
    case StationTypeIso_closedExit:
    case StationTypeIso_closedCredit:
    case StationTypeIso_mixed:
    case StationTypeIso_passage:
    case StationTypeIso_checkpoint:
    case StationTypeIso_reload:
    case StationTypeIso_reservedForFutureCENUse1:
    case StationTypeIso_reservedForFutureCENUse2:
    case StationTypeIso_reservedForFutureCENUse3:
    case StationTypeIso_reservedForFutureCENUse4:
    case StationTypeIso_privateUse5:
    case StationTypeIso_privateUse6:
        return 0;
    }
    return -1;
}
