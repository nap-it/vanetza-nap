...
static int asn_validate_RequestSubRole(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RequestSubRole value = *(e_RequestSubRole*)sptr;
    switch(value) {
    case RequestSubRole_requestSubRoleUnKnown:
    case RequestSubRole_requestSubRole1:
    case RequestSubRole_requestSubRole2:
    case RequestSubRole_requestSubRole3:
    case RequestSubRole_requestSubRole4:
    case RequestSubRole_requestSubRole5:
    case RequestSubRole_requestSubRole6:
    case RequestSubRole_requestSubRole7:
    case RequestSubRole_requestSubRole8:
    case RequestSubRole_requestSubRole9:
    case RequestSubRole_requestSubRole10:
    case RequestSubRole_requestSubRole11:
    case RequestSubRole_requestSubRole12:
    case RequestSubRole_requestSubRole13:
    case RequestSubRole_requestSubRole14:
    case RequestSubRole_requestSubRoleReserved:
        return 0;
    }
    return -1;
}
