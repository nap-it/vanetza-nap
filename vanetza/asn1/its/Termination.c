...
static int asn_validate_Termination(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Termination value = *(e_Termination*)sptr;
    switch(value) {
    case Termination_isCancellation:
    case Termination_isNegation:
        return 0;
    }
    return -1;
}
