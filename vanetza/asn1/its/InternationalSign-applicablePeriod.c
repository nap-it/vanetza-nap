...
extern asn_TYPE_descriptor_t asn_DEF_year __attribute__((weak, alias("asn_DEF_year_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_year_2;
asn_TYPE_descriptor_t asn_DEF_year;
__attribute__((constructor)) static void asn_DEF_year_2_alias_init(void) {
	asn_DEF_year = asn_DEF_year_2;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_month_day __attribute__((weak, alias("asn_DEF_month_day_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_month_day_5;
asn_TYPE_descriptor_t asn_DEF_month_day;
__attribute__((constructor)) static void asn_DEF_month_day_5_alias_init(void) {
	asn_DEF_month_day = asn_DEF_month_day_5;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_hourMinutes __attribute__((weak, alias("asn_DEF_hourMinutes_9")));
#else
static asn_TYPE_descriptor_t asn_DEF_hourMinutes_9;
asn_TYPE_descriptor_t asn_DEF_hourMinutes;
__attribute__((constructor)) static void asn_DEF_hourMinutes_9_alias_init(void) {
	asn_DEF_hourMinutes = asn_DEF_hourMinutes_9;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
