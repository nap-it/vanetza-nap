...
static int asn_validate_ThrottleConfidence(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ThrottleConfidence value = *(e_ThrottleConfidence*)sptr;
    switch(value) {
    case ThrottleConfidence_unavailable:
    case ThrottleConfidence_prec10percent:
    case ThrottleConfidence_prec1percent:
    case ThrottleConfidence_prec0_5percent:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ThrottleConfidence = {
		...
		/sizeof(asn_DEF_ThrottleConfidence_tags_1[0]), /* 1 */
	{
		...
		asn_validate_ThrottleConfidence
	},
