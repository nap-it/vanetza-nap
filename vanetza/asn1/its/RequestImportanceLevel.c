...
static int asn_validate_RequestImportanceLevel(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RequestImportanceLevel value = *(e_RequestImportanceLevel*)sptr;
    switch(value) {
    case RequestImportanceLevel_requestImportanceLevelUnKnown:
    case RequestImportanceLevel_requestImportanceLevel1:
    case RequestImportanceLevel_requestImportanceLevel2:
    case RequestImportanceLevel_requestImportanceLevel3:
    case RequestImportanceLevel_requestImportanceLevel4:
    case RequestImportanceLevel_requestImportanceLevel5:
    case RequestImportanceLevel_requestImportanceLevel6:
    case RequestImportanceLevel_requestImportanceLevel7:
    case RequestImportanceLevel_requestImportanceLevel8:
    case RequestImportanceLevel_requestImportanceLevel9:
    case RequestImportanceLevel_requestImportanceLevel10:
    case RequestImportanceLevel_requestImportanceLevel11:
    case RequestImportanceLevel_requestImportanceLevel12:
    case RequestImportanceLevel_requestImportanceLevel13:
    case RequestImportanceLevel_requestImportanceLevel14:
    case RequestImportanceLevel_requestImportanceReserved:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RequestImportanceLevel = {
		...
		/sizeof(asn_DEF_RequestImportanceLevel_tags_1[0]), /* 1 */
	{
		...
		asn_validate_RequestImportanceLevel
	},
