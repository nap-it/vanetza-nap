...
static int asn_validate_EuVehicleCategoryO(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EuVehicleCategoryO value = *(e_EuVehicleCategoryO*)sptr;
    switch(value) {
    case EuVehicleCategoryO_o1:
    case EuVehicleCategoryO_o2:
    case EuVehicleCategoryO_o3:
    case EuVehicleCategoryO_o4:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_EuVehicleCategoryO = {
		...
		/sizeof(asn_DEF_EuVehicleCategoryO_tags_1[0]), /* 1 */
	{
		...
		asn_validate_EuVehicleCategoryO
	},
