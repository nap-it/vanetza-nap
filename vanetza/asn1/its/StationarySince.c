...
static int asn_validate_StationarySince(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_StationarySince value = *(e_StationarySince*)sptr;
    switch(value) {
    case StationarySince_lessThan1Minute:
    case StationarySince_lessThan2Minutes:
    case StationarySince_lessThan15Minutes:
    case StationarySince_equalOrGreater15Minutes:
        return 0;
    }
    return -1;
}
