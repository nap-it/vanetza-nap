...
static int asn_validate_Vanetza_ITS2_ObjectFace(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Vanetza_ITS2_ObjectFace value = *(e_Vanetza_ITS2_ObjectFace*)sptr;
    switch(value) {
    case Vanetza_ITS2_ObjectFace_front:
    case Vanetza_ITS2_ObjectFace_sideLeftFront:
    case Vanetza_ITS2_ObjectFace_sideLeftBack:
    case Vanetza_ITS2_ObjectFace_sideRightFront:
    case Vanetza_ITS2_ObjectFace_sideRightBack:
    case Vanetza_ITS2_ObjectFace_back:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Vanetza_ITS2_ObjectFace = {
		...
		/sizeof(asn_DEF_Vanetza_ITS2_ObjectFace_tags_1[0]), /* 1 */
	{
		...
		asn_validate_Vanetza_ITS2_ObjectFace
	},
