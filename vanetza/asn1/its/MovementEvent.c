...
extern asn_TYPE_descriptor_t asn_DEF_regional __attribute__((weak, alias("asn_DEF_regional_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_regional_5;
asn_TYPE_descriptor_t asn_DEF_regional;
__attribute__((constructor)) static void asn_DEF_regional_5_alias_init(void) {
	asn_DEF_regional = asn_DEF_regional_5;
}
#endif
