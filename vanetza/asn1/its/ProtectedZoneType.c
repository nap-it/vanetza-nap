...
static int asn_validate_ProtectedZoneType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ProtectedZoneType value = *(e_ProtectedZoneType*)sptr;
    switch(value) {
...
asn_TYPE_descriptor_t asn_DEF_ProtectedZoneType = {
		...
		/sizeof(asn_DEF_ProtectedZoneType_tags_1[0]), /* 1 */
	{
		...
		asn_validate_ProtectedZoneType
	},
