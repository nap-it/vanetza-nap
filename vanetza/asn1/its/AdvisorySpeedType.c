...
static int asn_validate_AdvisorySpeedType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_AdvisorySpeedType value = *(e_AdvisorySpeedType*)sptr;
    switch(value) {
    case AdvisorySpeedType_none:
    case AdvisorySpeedType_greenwave:
    case AdvisorySpeedType_ecoDrive:
    case AdvisorySpeedType_transit:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_AdvisorySpeedType = {
		...
		/sizeof(asn_DEF_AdvisorySpeedType_tags_1[0]), /* 1 */
	{
		...
		asn_validate_AdvisorySpeedType
	},
