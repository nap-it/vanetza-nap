...
static int asn_validate_PrioritizationResponseStatus(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PrioritizationResponseStatus value = *(e_PrioritizationResponseStatus*)sptr;
    switch(value) {
    case PrioritizationResponseStatus_unknown:
    case PrioritizationResponseStatus_requested:
    case PrioritizationResponseStatus_processing:
    case PrioritizationResponseStatus_watchOtherTraffic:
    case PrioritizationResponseStatus_granted:
    case PrioritizationResponseStatus_rejected:
    case PrioritizationResponseStatus_maxPresence:
    case PrioritizationResponseStatus_reserviceLocked:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PrioritizationResponseStatus = {
		...
		/sizeof(asn_DEF_PrioritizationResponseStatus_tags_1[0]), /* 1 */
	{
		...
		asn_validate_PrioritizationResponseStatus
	},
