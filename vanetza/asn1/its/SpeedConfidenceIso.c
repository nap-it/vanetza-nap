...
static int asn_validate_SpeedConfidenceIso(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SpeedConfidenceIso value = *(e_SpeedConfidenceIso*)sptr;
    switch(value) {
    case SpeedConfidenceIso_unavailable:
    case SpeedConfidenceIso_prec100ms:
    case SpeedConfidenceIso_prec10ms:
    case SpeedConfidenceIso_prec5ms:
    case SpeedConfidenceIso_prec1ms:
    case SpeedConfidenceIso_prec0_1ms:
    case SpeedConfidenceIso_prec0_05ms:
    case SpeedConfidenceIso_prec0_01ms:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SpeedConfidenceIso = {
		...
		/sizeof(asn_DEF_SpeedConfidenceIso_tags_1[0]), /* 1 */
	{
		...
		asn_validate_SpeedConfidenceIso
	},
