...
static int asn_validate_DangerousGoodsBasic(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_DangerousGoodsBasic value = *(e_DangerousGoodsBasic*)sptr;
    switch(value) {
    case DangerousGoodsBasic_explosives1:
    case DangerousGoodsBasic_explosives2:
    case DangerousGoodsBasic_explosives3:
    case DangerousGoodsBasic_explosives4:
    case DangerousGoodsBasic_explosives5:
    case DangerousGoodsBasic_explosives6:
    case DangerousGoodsBasic_flammableGases:
    case DangerousGoodsBasic_nonFlammableGases:
    case DangerousGoodsBasic_toxicGases:
    case DangerousGoodsBasic_flammableLiquids:
    case DangerousGoodsBasic_flammableSolids:
    case DangerousGoodsBasic_substancesLiableToSpontaneousCombustion:
    case DangerousGoodsBasic_substancesEmittingFlammableGasesUponContactWithWater:
    case DangerousGoodsBasic_oxidizingSubstances:
    case DangerousGoodsBasic_organicPeroxides:
    case DangerousGoodsBasic_toxicSubstances:
    case DangerousGoodsBasic_infectiousSubstances:
    case DangerousGoodsBasic_radioactiveMaterial:
    case DangerousGoodsBasic_corrosiveSubstances:
    case DangerousGoodsBasic_miscellaneousDangerousSubstances:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_DangerousGoodsBasic = {
		...
		/sizeof(asn_DEF_DangerousGoodsBasic_tags_1[0]), /* 1 */
	{
		...
		asn_validate_DangerousGoodsBasic
	},
