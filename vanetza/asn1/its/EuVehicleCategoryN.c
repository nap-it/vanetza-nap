...
static int asn_validate_EuVehicleCategoryN(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EuVehicleCategoryN value = *(e_EuVehicleCategoryN*)sptr;
    switch(value) {
    case EuVehicleCategoryN_n1:
    case EuVehicleCategoryN_n2:
    case EuVehicleCategoryN_n3:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_EuVehicleCategoryN = {
		...
		/sizeof(asn_DEF_EuVehicleCategoryN_tags_1[0]), /* 1 */
	{
		...
		asn_validate_EuVehicleCategoryN
	},
