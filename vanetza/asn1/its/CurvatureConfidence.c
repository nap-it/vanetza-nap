...
static int asn_validate_CurvatureConfidence(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CurvatureConfidence value = *(e_CurvatureConfidence*)sptr;
    switch(value) {
    case CurvatureConfidence_onePerMeter_0_00002:
    case CurvatureConfidence_onePerMeter_0_0001:
    case CurvatureConfidence_onePerMeter_0_0005:
    case CurvatureConfidence_onePerMeter_0_002:
    case CurvatureConfidence_onePerMeter_0_01:
    case CurvatureConfidence_onePerMeter_0_1:
    case CurvatureConfidence_outOfRange:
    case CurvatureConfidence_unavailable:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CurvatureConfidence = {
		...
		/sizeof(asn_DEF_CurvatureConfidence_tags_1[0]), /* 1 */
	{
		...
		asn_validate_CurvatureConfidence
	},
