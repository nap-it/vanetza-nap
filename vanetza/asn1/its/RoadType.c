...
static int asn_validate_RoadType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RoadType value = *(e_RoadType*)sptr;
    switch(value) {
    case RoadType_urban_NoStructuralSeparationToOppositeLanes:
    case RoadType_urban_WithStructuralSeparationToOppositeLanes:
    case RoadType_nonUrban_NoStructuralSeparationToOppositeLanes:
    case RoadType_nonUrban_WithStructuralSeparationToOppositeLanes:
        return 0;
    }
    return -1;
}
