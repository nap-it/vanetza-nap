...
static int asn_validate_VehicleLengthConfidenceIndication(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_VehicleLengthConfidenceIndication value = *(e_VehicleLengthConfidenceIndication*)sptr;
    switch(value) {
    case VehicleLengthConfidenceIndication_noTrailerPresent:
    case VehicleLengthConfidenceIndication_trailerPresentWithKnownLength:
    case VehicleLengthConfidenceIndication_trailerPresentWithUnknownLength:
    case VehicleLengthConfidenceIndication_trailerPresenceIsUnknown:
    case VehicleLengthConfidenceIndication_unavailable:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_VehicleLengthConfidenceIndication = {
		...
		/sizeof(asn_DEF_VehicleLengthConfidenceIndication_tags_1[0]), /* 1 */
	{
		...
		asn_validate_VehicleLengthConfidenceIndication
	},
