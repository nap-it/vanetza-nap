...
static int asn_validate_MovementPhaseState(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_MovementPhaseState value = *(e_MovementPhaseState*)sptr;
    switch(value) {
...
asn_TYPE_descriptor_t asn_DEF_MovementPhaseState = {
		...
		/sizeof(asn_DEF_MovementPhaseState_tags_1[0]), /* 1 */
	{
		...
		asn_validate_MovementPhaseState
	},
