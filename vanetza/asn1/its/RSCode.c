...
extern asn_TYPE_descriptor_t asn_DEF_code __attribute__((weak, alias("asn_DEF_code_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_code_3;
asn_TYPE_descriptor_t asn_DEF_code;
__attribute__((constructor)) static void asn_DEF_code_3_alias_init(void) {
	asn_DEF_code = asn_DEF_code_3;
}
#endif
