...
static int asn_validate_RTCM_Revision(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RTCM_Revision value = *(e_RTCM_Revision*)sptr;
    switch(value) {
    case RTCM_Revision_unknown:
    case RTCM_Revision_rtcmRev2:
    case RTCM_Revision_rtcmRev3:
    case RTCM_Revision_reserved:
        return 0;
    }
    return -1;
}
