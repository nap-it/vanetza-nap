...
static int asn_validate_EmissionType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EmissionType value = *(e_EmissionType*)sptr;
    switch(value) {
    case EmissionType_euro1:
    case EmissionType_euro2:
    case EmissionType_euro3:
    case EmissionType_euro4:
    case EmissionType_euro5:
    case EmissionType_euro6:
        return 0;
    }
    return -1;
}
