...
static int asn_validate_EuVehicleCategoryL(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EuVehicleCategoryL value = *(e_EuVehicleCategoryL*)sptr;
    switch(value) {
    case EuVehicleCategoryL_l1:
    case EuVehicleCategoryL_l2:
    case EuVehicleCategoryL_l3:
    case EuVehicleCategoryL_l4:
    case EuVehicleCategoryL_l5:
    case EuVehicleCategoryL_l6:
    case EuVehicleCategoryL_l7:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_EuVehicleCategoryL = {
		...
		/sizeof(asn_DEF_EuVehicleCategoryL_tags_1[0]), /* 1 */
	{
		...
		asn_validate_EuVehicleCategoryL
	},
