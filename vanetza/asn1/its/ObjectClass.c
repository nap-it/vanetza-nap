...
extern asn_TYPE_descriptor_t asn_DEF_class __attribute__((weak, alias("asn_DEF_class_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_class_3;
asn_TYPE_descriptor_t asn_DEF_class;
__attribute__((constructor)) static void asn_DEF_class_3_alias_init(void) {
	asn_DEF_class = asn_DEF_class_3;
}
#endif
