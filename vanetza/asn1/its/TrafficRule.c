...
static int asn_validate_TrafficRule(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_TrafficRule value = *(e_TrafficRule*)sptr;
    switch(value) {
    case TrafficRule_noPassing:
    case TrafficRule_noPassingForTrucks:
    case TrafficRule_passToRight:
    case TrafficRule_passToLeft:
        return 0;
    }
    return -1;
}
