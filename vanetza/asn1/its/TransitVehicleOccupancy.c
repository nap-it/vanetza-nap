...
static int asn_validate_TransitVehicleOccupancy(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_TransitVehicleOccupancy value = *(e_TransitVehicleOccupancy*)sptr;
    switch(value) {
    case TransitVehicleOccupancy_occupancyUnknown:
    case TransitVehicleOccupancy_occupancyEmpty:
    case TransitVehicleOccupancy_occupancyVeryLow:
    case TransitVehicleOccupancy_occupancyLow:
    case TransitVehicleOccupancy_occupancyMed:
    case TransitVehicleOccupancy_occupancyHigh:
    case TransitVehicleOccupancy_occupancyNearlyFull:
    case TransitVehicleOccupancy_occupancyFull:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_TransitVehicleOccupancy = {
		...
		/sizeof(asn_DEF_TransitVehicleOccupancy_tags_1[0]), /* 1 */
	{
		...
		asn_validate_TransitVehicleOccupancy
	},
