...
extern asn_TYPE_descriptor_t asn_DEF_trafficSignPictogram __attribute__((weak, alias("asn_DEF_trafficSignPictogram_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_trafficSignPictogram_5;
asn_TYPE_descriptor_t asn_DEF_trafficSignPictogram;
__attribute__((constructor)) static void asn_DEF_trafficSignPictogram_5_alias_init(void) {
	asn_DEF_trafficSignPictogram = asn_DEF_trafficSignPictogram_5;
}
#endif
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_publicFacilitiesPictogram __attribute__((weak, alias("asn_DEF_publicFacilitiesPictogram_10")));
#else
static asn_TYPE_descriptor_t asn_DEF_publicFacilitiesPictogram_10;
asn_TYPE_descriptor_t asn_DEF_publicFacilitiesPictogram;
__attribute__((constructor)) static void asn_DEF_publicFacilitiesPictogram_10_alias_init(void) {
	asn_DEF_publicFacilitiesPictogram = asn_DEF_publicFacilitiesPictogram_10;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_ambientOrRoadConditionPictogram __attribute__((weak, alias("asn_DEF_ambientOrRoadConditionPictogram_13")));
#else
static asn_TYPE_descriptor_t asn_DEF_ambientOrRoadConditionPictogram_13;
asn_TYPE_descriptor_t asn_DEF_ambientOrRoadConditionPictogram;
__attribute__((constructor)) static void asn_DEF_ambientOrRoadConditionPictogram_13_alias_init(void) {
	asn_DEF_ambientOrRoadConditionPictogram = asn_DEF_ambientOrRoadConditionPictogram_13;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_serviceCategoryCode __attribute__((weak, alias("asn_DEF_serviceCategoryCode_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_serviceCategoryCode_4;
asn_TYPE_descriptor_t asn_DEF_serviceCategoryCode;
__attribute__((constructor)) static void asn_DEF_serviceCategoryCode_4_alias_init(void) {
	asn_DEF_serviceCategoryCode = asn_DEF_serviceCategoryCode_4;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static int
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_pictogramCategoryCode __attribute__((weak, alias("asn_DEF_pictogramCategoryCode_18")));
#else
static asn_TYPE_descriptor_t asn_DEF_pictogramCategoryCode_18;
asn_TYPE_descriptor_t asn_DEF_pictogramCategoryCode;
__attribute__((constructor)) static void asn_DEF_pictogramCategoryCode_18_alias_init(void) {
	asn_DEF_pictogramCategoryCode = asn_DEF_pictogramCategoryCode_18;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static int
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_pictogramCode __attribute__((weak, alias("asn_DEF_pictogramCode_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_pictogramCode_2;
asn_TYPE_descriptor_t asn_DEF_pictogramCode;
__attribute__((constructor)) static void asn_DEF_pictogramCode_2_alias_init(void) {
	asn_DEF_pictogramCode = asn_DEF_pictogramCode_2;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
...
static int asn_validate_trafficSignPictogram(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_GddStructure__pictogramCode__serviceCategoryCode__trafficSignPictogram value = *(e_GddStructure__pictogramCode__serviceCategoryCode__trafficSignPictogram*)sptr;
    switch(value) {
    case GddStructure__pictogramCode__serviceCategoryCode__trafficSignPictogram_dangerWarning:
    case GddStructure__pictogramCode__serviceCategoryCode__trafficSignPictogram_regulatory:
    case GddStructure__pictogramCode__serviceCategoryCode__trafficSignPictogram_informative:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_trafficSignPictogram_5 = {
		...
		/sizeof(asn_DEF_trafficSignPictogram_tags_5[0]), /* 2 */
	{
		...
		asn_validate_trafficSignPictogram
	},
...
static int asn_validate_publicFacilitiesPictogram(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_GddStructure__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram value = *(e_GddStructure__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram*)sptr;
    switch(value) {
    case GddStructure__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram_publicFacilities:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_publicFacilitiesPictogram_10 = {
		...
		/sizeof(asn_DEF_publicFacilitiesPictogram_tags_10[0]), /* 2 */
	{
		...
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_publicFacilitiesPictogram
	},
	0, 0,	/* Defined elsewhere */
...
static int asn_validate_ambientOrRoadConditionPictogram(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_GddStructure__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram value = *(e_GddStructure__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram*)sptr;
    switch(value) {
    case GddStructure__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram_ambientCondition:
    case GddStructure__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram_roadCondition:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ambientOrRoadConditionPictogram_13 = {
		...
		/sizeof(asn_DEF_ambientOrRoadConditionPictogram_tags_13[0]), /* 2 */
	{
		...
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_ambientOrRoadConditionPictogram
	},
	0, 0,	/* Defined elsewhere */
