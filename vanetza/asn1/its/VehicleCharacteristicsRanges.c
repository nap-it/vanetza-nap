...
extern asn_TYPE_descriptor_t asn_DEF_limits __attribute__((weak, alias("asn_DEF_limits_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_limits_3;
asn_TYPE_descriptor_t asn_DEF_limits;
__attribute__((constructor)) static void asn_DEF_limits_3_alias_init(void) {
	asn_DEF_limits = asn_DEF_limits_3;
}
#endif
