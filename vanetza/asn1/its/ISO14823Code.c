...
static int asn_validate_trafficSignPictogram(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ISO14823Code__pictogramCode__serviceCategoryCode__trafficSignPictogram value = *(e_ISO14823Code__pictogramCode__serviceCategoryCode__trafficSignPictogram*)sptr;
    switch(value) {
...
static int asn_validate_publicFacilitiesPictogram(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ISO14823Code__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram value = *(e_ISO14823Code__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram*)sptr;
    switch(value) {
    case ISO14823Code__pictogramCode__serviceCategoryCode__publicFacilitiesPictogram_publicFacilities:
        return 0;
    }
    return -1;
}
...
static int asn_validate_ambientOrRoadConditionPictogram(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ISO14823Code__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram value = *(e_ISO14823Code__pictogramCode__serviceCategoryCode__ambientOrRoadConditionPictogram*)sptr;
    switch(value) {
