...
extern asn_TYPE_descriptor_t asn_DEF_offsetXaxis __attribute__((weak, alias("asn_DEF_offsetXaxis_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_offsetXaxis_3;
asn_TYPE_descriptor_t asn_DEF_offsetXaxis;
__attribute__((constructor)) static void asn_DEF_offsetXaxis_3_alias_init(void) {
	asn_DEF_offsetXaxis = asn_DEF_offsetXaxis_3;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_offsetYaxis __attribute__((weak, alias("asn_DEF_offsetYaxis_6")));
#else
static asn_TYPE_descriptor_t asn_DEF_offsetYaxis_6;
asn_TYPE_descriptor_t asn_DEF_offsetYaxis;
__attribute__((constructor)) static void asn_DEF_offsetYaxis_6_alias_init(void) {
	asn_DEF_offsetYaxis = asn_DEF_offsetYaxis_6;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_regional __attribute__((weak, alias("asn_DEF_regional_12")));
#else
static asn_TYPE_descriptor_t asn_DEF_regional_12;
asn_TYPE_descriptor_t asn_DEF_regional;
__attribute__((constructor)) static void asn_DEF_regional_12_alias_init(void) {
	asn_DEF_regional = asn_DEF_regional_12;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static int
