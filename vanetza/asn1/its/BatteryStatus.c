...
static int asn_validate_BatteryStatus(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_BatteryStatus value = *(e_BatteryStatus*)sptr;
    switch(value) {
    case BatteryStatus_unknown:
    case BatteryStatus_critical:
    case BatteryStatus_low:
    case BatteryStatus_good:
        return 0;
    }
    return -1;
}
