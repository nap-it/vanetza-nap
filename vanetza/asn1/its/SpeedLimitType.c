...
static int asn_validate_SpeedLimitType(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SpeedLimitType value = *(e_SpeedLimitType*)sptr;
    switch(value) {
    case SpeedLimitType_unknown:
