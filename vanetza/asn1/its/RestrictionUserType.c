...
extern asn_TYPE_descriptor_t asn_DEF_regional __attribute__((weak, alias("asn_DEF_regional_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_regional_3;
asn_TYPE_descriptor_t asn_DEF_regional;
__attribute__((constructor)) static void asn_DEF_regional_3_alias_init(void) {
	asn_DEF_regional = asn_DEF_regional_3;
}
#endif
