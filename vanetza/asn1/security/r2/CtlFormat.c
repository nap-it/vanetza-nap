...
extern asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_ctlCommands __attribute__((weak, alias("asn_DEF_Vanetza_Security2_ctlCommands_6")));
#else
static asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_ctlCommands_6;
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_ctlCommands;
__attribute__((constructor)) static void asn_DEF_Vanetza_Security2_ctlCommands_6_alias_init(void) {
	asn_DEF_Vanetza_Security2_ctlCommands = asn_DEF_Vanetza_Security2_ctlCommands_6;
}
#endif
...
asn_TYPE_member_t asn_MBR_Vanetza_Security2_CtlFormat_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_CtlFormat, ctlCommands),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_Vanetza_Security2_ctlCommands,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
