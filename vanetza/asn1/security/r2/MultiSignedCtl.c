...
static const long asn_VAL_Vanetza_Security2_Ieee1609dot2dot1Ctls_1_Vanetza_Security2_fullIeeeCtl = 1;
...
static const asn_ioc_cell_t asn_IOS_Vanetza_Security2_Ieee1609dot2dot1Ctls_1_rows[] = {
	{ "&type", aioc__value, &asn_DEF_NativeInteger, &asn_VAL_Vanetza_Security2_Ieee1609dot2dot1Ctls_1_Vanetza_Security2_fullIeeeCtl },
...
extern asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_signatures __attribute__((weak, alias("asn_DEF_Vanetza_Security2_signatures_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_signatures_5;
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_signatures;
__attribute__((constructor)) static void asn_DEF_Vanetza_Security2_signatures_5_alias_init(void) {
	asn_DEF_Vanetza_Security2_signatures = asn_DEF_Vanetza_Security2_signatures_5;
}
#endif
...
asn_TYPE_member_t asn_MBR_Vanetza_Security2_MultiSignedCtl_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Vanetza_Security2_MultiSignedCtl, signatures),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_Vanetza_Security2_signatures,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
