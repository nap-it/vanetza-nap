...
static int asn_validate_Vanetza_Security2_EnrolmentResponseCode(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Vanetza_Security2_EnrolmentResponseCode value = *(e_Vanetza_Security2_EnrolmentResponseCode*)sptr;
    switch(value) {
    case Vanetza_Security2_EnrolmentResponseCode_ok:
    case Vanetza_Security2_EnrolmentResponseCode_cantparse:
    case Vanetza_Security2_EnrolmentResponseCode_badcontenttype:
    case Vanetza_Security2_EnrolmentResponseCode_imnottherecipient:
    case Vanetza_Security2_EnrolmentResponseCode_unknownencryptionalgorithm:
    case Vanetza_Security2_EnrolmentResponseCode_decryptionfailed:
    case Vanetza_Security2_EnrolmentResponseCode_unknownits:
    case Vanetza_Security2_EnrolmentResponseCode_invalidsignature:
    case Vanetza_Security2_EnrolmentResponseCode_invalidencryptionkey:
    case Vanetza_Security2_EnrolmentResponseCode_baditsstatus:
    case Vanetza_Security2_EnrolmentResponseCode_incompleterequest:
    case Vanetza_Security2_EnrolmentResponseCode_deniedpermissions:
    case Vanetza_Security2_EnrolmentResponseCode_invalidkeys:
    case Vanetza_Security2_EnrolmentResponseCode_deniedrequest:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security2_EnrolmentResponseCode = {
		...
		/sizeof(asn_DEF_Vanetza_Security2_EnrolmentResponseCode_tags_1[0]), /* 1 */
	{
		...
		asn_validate_Vanetza_Security2_EnrolmentResponseCode
	},
