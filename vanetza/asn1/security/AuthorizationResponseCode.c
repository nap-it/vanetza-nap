...
static int asn_validate_Vanetza_Security_AuthorizationResponseCode(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Vanetza_Security_AuthorizationResponseCode value = *(e_Vanetza_Security_AuthorizationResponseCode*)sptr;
    switch(value) {
...
asn_TYPE_descriptor_t asn_DEF_Vanetza_Security_AuthorizationResponseCode = {
		...
		/sizeof(asn_DEF_Vanetza_Security_AuthorizationResponseCode_tags_1[0]), /* 1 */
	{
		...
		asn_validate_Vanetza_Security_AuthorizationResponseCode
	},
