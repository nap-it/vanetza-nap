...
bool decode_per_debug(asn_TYPE_descriptor_t&, void**, const void* buffer, std::size_t size, std::string& error_info);
...
public:
    ...
    bool decode_debug(const void* buffer, std::size_t len, std::string& error_info)
    {
        return vanetza::asn1::decode_per_debug(base::m_type, (void**)&(base::m_struct), buffer, len, error_info);
    }
